...
| 6 | workflow.md | 개발 사고 가이드 (9단계 워크플로우 내부 참고용 사고 가이드) |
...
- **재정의**: `workflow.md`는 별도 단계 시스템이 아닌 **사고 가이드**. 본 저장소 강제 워크플로우는 `0_CODEX_RULES.md §9` 9단계 + `.claude/skills/workflow/SKILL.md` (강제 룰 SSOT)
