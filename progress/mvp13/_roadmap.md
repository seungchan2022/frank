...
| 마일스톤 | 주제 | 앱 | 상태 |
|----------|------|----|------|
| M1 | DEBT-01 — 오답 태그 필터 (서버+DB) | 서버 | 🔄 in-progress |
| M2 | 오답 태그 필터 클라이언트 전환 + 피드 품질 개선 | 웹+iOS | 🔲 planning |
| M3 | 클라우드 배포 | 서버+웹+iOS | 🔲 planning |
...
**전제 조건**: Oracle VM 생성 완료 (사용자 수동 작업) 후 워크플로우 시작.
