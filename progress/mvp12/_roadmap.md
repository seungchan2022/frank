...
| M2 | 웹 버그 수정 + UX 개선 | BUG-C, BUG-F(웹), 좋아요/즐겨찾기 UX 재설계, 무한 스크롤 | 웹 | 🔵 in-progress |
| M3 | iOS 버그 수정 + UX 개선 (M2 싱크) | BUG-D, BUG-E, BUG-F(iOS), 좋아요/즐겨찾기 UX 재설계(M2 기준), 무한 스크롤 | iOS | 🔲 planning |
