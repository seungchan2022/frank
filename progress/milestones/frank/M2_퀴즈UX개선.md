...
- [ ] 퀴즈 완료 화면: 이번 세션 오답 목록 인라인 표시 (웹·iOS)
- [ ] 기사 상세 퀴즈 버튼: 완료 전 "퀴즈 풀기" / 완료 후 "다시 풀기" + "오답 보기" (웹·iOS)
- [ ] "오답 보기" 클릭 시 시트로 오답 목록 표시 (웹·iOS)
- [ ] 서버 변경 없음 — 기존 엔드포인트·DB 그대로
...
| # | 아이템 | 유형 | 실행 스킬 | 상태 |
|---|--------|------|----------|------|
| 1 | 퀴즈 완료 화면 오답 인라인 표시 (웹+iOS) | feature | /workflow | 대기 |
| 2 | 기사 상세 퀴즈 버튼 재설계 (웹+iOS) | feature | /workflow | 대기 |
