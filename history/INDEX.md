...
## MVP4 — 부채 해소 + 품질 개선 (260408~)

> M1~M4 완료. M5(데이터 품질) 대기. UITest 4개 + coverage.sh + Mock 주입 인프라.
...
| MVP4 | 부채 해소 + 품질 개선 (서버-웹-앱 연동 전 정지) | 📋 계획 |
| MVP5 | 학습 기능 (스크랩, 퀴즈 등) — 서버-웹-앱 연동 기반 위에서 | 💭 미정 |
