...
## MVP11 — 하네스 엔지니어링·KPI 게이트 메타 개선 (260418~)

> 기획 단계. 코드가 아니라 **AI·나의 협업 환경 자체**를 손본 구간. 하네스 분석 2문서 × frank 실측 대조 → 갭 식별 → 문서 원칙을 기계 강제로 격상.

| 유형 | 파일 | 핵심 내용 |
|------|------|----------|
| 회고 | [일일 회고 260418](mvp11/260418_daily_retro.md) | 2층 KPI 게이트·`/critical-review` 스킬·하네스 hook·G1 스케일 조정, 내일 TODO = G1 Feature List 자동 생성 스킬 |
...
| MVP11 | 하네스 엔지니어링·KPI 게이트 메타 개선 | 🟡 기획 중 |
