...
| M3 | 웹 UX 개선 (요약 timeout) | 0.5~1일 | 없음 | ✅ 완료 |
| M4 | iOS 테스트 인프라 (UITest 4개 + 커버리지 파이프라인) | 2~3일 | M2 완료 후 | ✅ 완료 |
| M5 | 데이터 품질 (태그 stale 해소 + Supabase 조사) | 2~3일 | 없음 | ✅ 완료 |
...
| 260408 | M3 완료 | 웹 요약 30s 타임아웃 UX — AbortController + iOS M2 패턴 싱크 |
| 260408 | M4 완료 | UITest TC-01~04 + coverage.sh + Mock scenario 주입 인프라 구축 |
| 260409 | M5 완료 | 태그 stale 기사 필터 (쿼리 수정) + Supabase Manual Linking 조사 + deploy.sh 웹 브라우저 자동 오픈 |
| 260409 | MVP4 전체 완료 | M1~M5 모두 완료 — MVP5(학습 기능) 진입 가능 |
