...
| 자료 | 설명 |
|------|------|
| [260409_개념정리_도식화.html](260409_개념정리_도식화.html) | 인증·토큰·저장소 흐름을 Mermaid 도식으로 시각화한 HTML (사이드바 네비게이션, 다크 테마) |

*최종 업데이트: 2026-04-09 (인증 vs 서비스 흐름 / JWT 토큰 / 저장소 비교 섹션 추가 + MVP2 다이어그램 수정 + HTML 참고 자료 링크)*
