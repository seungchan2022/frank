...
| 마일스톤 | 목표 | 기간 | 의존성 | 상태 |
|----------|------|------|--------|------|
| M1 | 검색엔진 진단 (research) | 1~2일 | 없음 | ✅ done (2026-05-02) |
| M2 | 양 확대 + 무료 한도 모니터링 (서버) | 2~3일 | M1 | ✅ done (2026-05-02) |
...
| 260502 | M1 done | 검색엔진 진단 보고서 작성 완료 |
| 260502 | M2 done | 양 확대(limit 5→20) + 한도 자동 보호 인프라 + iMessage 알림 + mock 토글 구현 완료 |
